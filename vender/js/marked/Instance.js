/** @typedef {import('./MarkedOptions.ts').MarkedExtension} MarkedExtension */
...
export class Marked {
    ...
    /** @default (opt: MarkedOptions) => this */
    options = this.setOptions;
    /** @default overloadedParse */
     ...
     * Run callback for every token
       ...
       * @param {(token: Token) => MaybePromise | MaybePromise[]} callback
    ...
    /**
       ...
       * @param {boolean} async
       * @returns {(e: Error) => string | Promise<string>}
       */
...
/** @typedef {(...args: unknown[]) => string | false} GenericRendererFunction */
